...
namespace ProductCatalog.Entity
{
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            {
                new Category(){ Name = "Camera", Description = "Products of Camera"},
                new Category(){ Name = "Computer", Description = "Products of Computer"},
                new Category(){ Name = "Electronic", Description = "Products of Electronic"},
                new Category(){ Name = "Telephone", Description = "Products of Telephone"},
                new Category(){ Name = "Home Appliance", Description = "Products of Home Appliance"}
            };
